...
<style>
    body {
        background-image: url('{{ asset('bootstrap-5.3.8-dist/images/bandara.png') }}');
    ...
    <div class="login-wrapper d-flex align-items-center justify-content-center w-100">
        <div class="card shadow">
            ...
            <div class="card-body p-4">
                ...
                <div class="text-center mt-4 pt-2 text-muted border-top"><small>Demo Login: admin@example.com / password</small></div>
            </div>
        </div>
    </div>
